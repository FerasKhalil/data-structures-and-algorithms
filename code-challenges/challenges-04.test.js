...
Write a function named addAnimal that takes in array of animals (strings) and some 
callback function.
...
Write a function called sortNumbers that takes an array of numbers and sorts them
...
Write a function named sortBackwards that takes in an array of numbers and returns the same 
array, with the numbers sorted, largest to smallest.
...
Write a function named alphabetize that takes in an array of strings and returns the 
same array with the strings sorted alphabetically.
...
Write a function named sortByPrice that takes in an array of objects, each of which 
has a 'price' property, and sorts those objects by price, lowest to highest, returning 
the same array.
